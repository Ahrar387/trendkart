...
export default async function CategoryPage({ params, searchParams }: Props) {
  ...
  return (
    <div className="container-site py-8 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">
            {cat.description} · {result.total.toLocaleString("en-IN")} products
          </p>
        </div>
      </div>

      {/* Sort filter — Client Component, safe inside Suspense */}
      ...
      {result.data.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <p className="text-gray-500 mb-6">
            We&apos;re adding {cat.name} products soon. Check back later!
          </p>
      ...
      {/* Pagination — Client Component, no onChange prop */}
